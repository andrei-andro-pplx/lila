import type { MessageSubmitData } from './interfaces';
...
export const parseRelayChatData = (text: string): RelayChatData | undefined => {
...
export const attachRelayChatData = (text: string, data?: MessageSubmitData): string => {
